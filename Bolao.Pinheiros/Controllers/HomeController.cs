...
namespace Bolao.Pinheiros.Controllers
{
    public class HomeController : SamlController
    {
        ...
        private static readonly List<int> EXCLUDE_COMPETITIONS = new List<int> { 104, 564, 5431, 5565, 5606, 5639, 5825, 6362, 6896, 7523, 7299, 7499, 7522, 7529, 7530, 7556, 7568, 7569 };
